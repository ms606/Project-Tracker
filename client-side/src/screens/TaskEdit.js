...
import StatusLineDetailEdit from "../components/StatusLineDetailEdit";
...
console.log('Calling tasks to see the status: tasks',tasks)
  ...
  return (
     <div className={`task ${collapsed ? "collapsedTask" : ""}`}>
        ...
        <input
          ...
          disabled={collapsed}
          defaultValue={tasks.expectedShipping}          
        />
